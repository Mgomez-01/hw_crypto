...
# This file was *autogenerated* from the file verifyPrimitive.sage
from sage.all_cmdline import *   # import sage library

_sage_const_37 = Integer(37); _sage_const_4 = Integer(4); _sage_const_1 = Integer(1)
...
degree = _sage_const_37 **_sage_const_4   # Since we are dealing with a quadratic polynomial
elements = [alpha**i for i in range(degree-_sage_const_1 )]  # used b/c any x^k = 1, so x^degree should be 1, and it is. removed it after verifying this to be the case
